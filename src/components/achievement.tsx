    ...
    return [
      {
        ...
        achievements: [
          {
            title: "Odoo On-site Hackathon 2025",
            description: "Gandhinagar hackathon with 19,000+ registrations",
            highlight: "Finalist + Full-Time Offer",
            icon: <Trophy className="h-5 w-5" />,
            importance: "high",
            description_long:
              "Triumphed a Top 50 finish out of 19,000+ registrations at the Odoo On-site Hackathon 2025 (Gandhinagar), leading frontend API handling and delivering a production-grade, scalable prototype. Received a full-time job offer from Odoo.",
            link: "",
          },
          {
            title: "Algo Utsav Contest",
            description: "Algorithmic programming competition with 2200+ teams",
            highlight: "Top 30",
            icon: <Trophy className="h-5 w-5" />,
            importance: "high",
            description_long:
              "Secured a spot among the Top 30 out of 2200+ teams in the Algo Utsav Contest, collaborating with a 4-member squad to architect efficient algorithms.",
            link: "",
          },
          {
            ...
            highlight: "College Round Cleared",
            icon: <Trophy className="h-5 w-5" />,
            importance: "high",
            description_long:
              "National-level hackathon organized by the Government of India",
