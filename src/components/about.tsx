      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-16">
          <div className="w-full lg:w-3/5">
            ...
            >
              <p>
                Hey, I&apos;m Ayush Singh, a Computer Science student at IIIT
                Kota. I enjoy solving complex problems and building
                scalable applications, with a focus on backend development, 
                frontend development and system programming.
              </p>
              <p>
                I am currently learning Operating Systems, Object-Oriented
                Programming, Computer Networks, DBMS, and System Design. I work with
                C++, Javascript, Node.js, PostgreSQL, continuously
              ...
              <p>
                ...
                and Framer Motion, ensuring seamless user experiences.
              </p>
              <p>
            ...
            >
              ...
              <div className="flex gap-3 sm:gap-4">
                <motion.a
                  href="https://www.instagram.com/_ayush.2004__?igsh=MXY2ZnVvaDQzd3RpYg=="
                  target="_blank"
                ...
                <motion.a
                  href="https://github.com/Ayush27641"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-[#565bac] transition-colors"
                  variants={socialIconAnimation}
                ...
                <motion.a
                  href="https://www.linkedin.com/in/ayush-singh-562287373/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-[#565bac] transition-colors"
                  variants={socialIconAnimation}
