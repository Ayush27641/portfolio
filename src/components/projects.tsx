  ...
  const list: ProjectProps[] = [
    {
      ...
      url: "https://github.com/Ayush27641/QuickCourt.git",
    ...
    },
    {
      ...
      name: "Clarity Vault",
      description:
        "**ClarityVault** is a GenAI-powered web app that lets you upload legal and financial PDFs for instant classification, translation, risk analysis, and conversational Q&A.",
      photo: "/clarityvault.png",
      url: "https://github.com/Ayush27641/ClarityVault.git",
      tags: ["React", "Node.js", "OpenAI", "Supabase", "Gemini API", "Full Stack", "AI"],
      date: "2025",
      featured: true,
    },
    {
