...
const profilesData: ProfilesData = {
  ...
  codeForces: {
    ...
    color: "#3b82f6",
    image: "/mad_monk.jpg",
    url: "https://codeforces.com/profile/ayush7175",
  },
  leetCode: {
    username: "Ayush27641",
    rating: 1858,
    ...
    color: "#ef4444",
    image: "/mad_monk.jpg",
    url: "https://leetcode.com/u/Ayush27641",
  },
  github: {
    username: "Ayush27641",
    repositories: 26,
    ...
    color: "#22c55e",
    image: "/mad_monk.jpg",
    url: "https://github.com/Ayush27641",
  },
};
...
const CodingProfileCard: React.FC<CodingProfileCardProps> = ({
  ...
  const renderStars = (): React.ReactNode => {
    const starCount = "stars" in profile ? (profile as CodeChefProfile).stars : 0;
    return Array(5)
      .fill(0)
      .map((_, index) => (
        <Star
