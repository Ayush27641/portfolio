      ...
      <div className="w-full h-screen flex justify-center items-center">
        ...
        >
          ...
          <motion.p
            ...
            variants={fadeInUp}
          >
            Pre-Final Year at Indian Institute of Information Technology Kota
          </motion.p>
          ...
          <motion.p
            ...
            variants={fadeInUp}
          >
            Over the past 2+ years at IIITK, I&apos;ve excelled in{" "}
            <Bold>full-stack development</Bold>
            with React.js/Next.js, <Bold>low-level programming</Bold>, <Bold>competitive coding</Bold>, and{" "}
